...
import { CacheData, extractCacheData, extractCacheItemData, retrieveCache } from "./getFromCache";
import { EXAMPLE_RAW_CACHE_RESPONSE_ALL, EXAMPLE_COMPRESSED_USER_DATA, EXAMPLE_COMPRESSED_PROJECT_DATA, EXAMPLE_COMPRESSED_TASKS_DATA, EXAMPLE_RAW_CACHE_RESPONSE_NO_USERS, EXAMPLE_RAW_CACHE_RESPONSE_NO_TASKS, EXAMPLE_RAW_CACHE_RESPONSE_NO_PROJECTS } from "../../test-data/cache/cacheResponse";
...
describe("Tests extractCacheItemData", () => {
    it("Should return the correctly decompressed user data", async () => {
        const decompressed = await extractCacheItemData(EXAMPLE_COMPRESSED_USER_DATA);
    ...
    it("Should return the correctly decompressed project data", async () => {
        const decompressed = await extractCacheItemData(EXAMPLE_COMPRESSED_PROJECT_DATA);
    ...
    it("Should return the correctly decompressed task data", async () => {
        const decompressed = await extractCacheItemData(EXAMPLE_COMPRESSED_TASKS_DATA);
...
describe("Tests extractCacheData", () => {
    ...
    it("Should return all project and task data, correctly decompressed", async () => {
        const decompressed = await extractCacheData(EXAMPLE_RAW_CACHE_RESPONSE_NO_USERS);
    ...
    it("Should return all project and user data, correctly decompressed", async () => {
        const decompressed = await extractCacheData(EXAMPLE_RAW_CACHE_RESPONSE_NO_TASKS);
    ...
    it("Should return all user and task data, correctly decompressed", async () => {
        const decompressed = await extractCacheData(EXAMPLE_RAW_CACHE_RESPONSE_NO_PROJECTS);
