...
describe("tests convertTaskPageFromDbResponse", () => {
  it("should correctly convert the database response into a TaskPage object", () => {
    ...
    expect(taskPage.task.description).toEqual(
      "Feed the cats every day. Give them their pills and ensure they have enough clean water.",
    );
    expect(taskPage.task.project).toMatchObject([
