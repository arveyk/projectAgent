...
describe("Tests filterSimilar", () => {
  it("", () => {
    ...
    console.log(JSON.stringify(similarPages));
...
//     const similarPages = filterSimilar(
//       dbPageList,
//       "add Tuxedo Mask, feed all the cats every day and give them water",
//     );
...
//       description:
//         "Feed the cats every day from November 1 to November 7. Give them their pills and ensure they have enough clean water.",
//       assignee: [],
//     });
//     expect(similarPages).toContainEqual({
...
//       taskTitle: "Feed the cats",
//       description:
//         "Feed the cats until next Monday. Make sure to give them their pills and that they have enough clean water.",
//       assignee: [
//         {
//           name: "Harvey Kisiangani",
//           email: "harveykisiangani@gmail.com",
...
//     const similarPages = filterSimilar(
//       dbPageList,
//       "Within the next week, please fatigue and stress test the section 34 fuselage.",
//     );
//     expect(similarPages).toContainEqual({
//       pageId: "293eef29-a653-8121-b265-cc85667429cb",
//       taskTitle: "Test section 34 fuselage for fatigue and stresses",
//       description:
//         "Test the section 34 fuselage for fatigue and other stresses. The task should be completed within one week.",
//       assignee: [],
//     });
//   });
...
//     const similarPages = filterSimilar(
//       dbPageList,
//       "add Prepare a sweet dessert for the dinner party by tomorrow",
//     );
//     expect(similarPages).toContainEqual({
//       pageId: "292eef29-a653-8127-9532-c1f31fd42614",
//       taskTitle: "Feed the emu and prepare for dinner",
//       description:
//         "Feed the emu and ensure she has enough water. Also, prepare something sweet for tomorrow's dinner.",
//       assignee: [
//         {
//           name: "Harvey Kisiangani",
//           email: "harveykisiangani@gmail.com",
...
//     const similarPages = filterSimilar(
//       dbPageList,
//       "add help crkurdelak feed the oldest cat in the fleet daily and give them clean water. Also, do not kill Tuxedo Mask",
//     );
//     expect(similarPages).toContainEqual({
//       pageId: "293eef29-a653-81d9-bf8e-fa797d755368",
//       taskTitle: "Fix left engine of oldest F22",
//       description:
//         "Help crkurdelak fix the left engine of the oldest F22 aircraft in the fleet.",
//       assignee: [
//         {
//           name: "Harvey Kisiangani",
//           email: "harveykisiangani@gmail.com",
...
//       description:
//         "Retrieve the last rainbow crystals from Tuxedo Mask without killing him. This task is considered a threat.",
//       assignee: [],
//     });
//   });
// });
