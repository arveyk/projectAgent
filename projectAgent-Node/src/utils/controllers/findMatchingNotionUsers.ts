 ...
 * @param alreadyFetchedUsers Notion users already fetched from the database.
 ...
 */
export async function findNotionProfileOfAssignedBy(appUserSlackProfile: User, foundUsers: ListUsersResponse | null) {
