...
const inputs = [
  ...
  // "Chimara, please observe the loudly meowing creatures, sometimes known as 'cats', and determine whether they have been given food. If they have not, give them some"
